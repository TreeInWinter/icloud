package com.cloud.stock.dao;

// Generated Apr 10, 2014 9:23:48 PM by Hibernate Tools 3.4.0.CR1
...
import com.cloud.stock.model.Stock;

/**
 * Home object for domain model class Stock.
 *
 * @see com.cloud.stock.dao.Stock
...
public class StockHome {
	...
	public Stock merge(Stock detachedInstance) {
		...
		try {
			Stock result = (Stock) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Stock findById(int id) {
		...
		try {
			Stock instance = (Stock) sessionFactory.getCurrentSession().get(
					"com.cloud.stock.dao.Stock", id);
			if (instance == null) {
	...
	public List findByExample(Stock instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.cloud.stock.dao.Stock")
