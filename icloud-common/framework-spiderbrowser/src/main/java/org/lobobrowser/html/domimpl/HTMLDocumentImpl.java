...
public class HTMLDocumentImpl extends NodeImpl implements HTMLDocument {
	...
	public HTMLCollection getImages() {
		synchronized(this) {
			if(this.images == null) {
				this.images = new FilteredHTMLCollectionImpl(this.elementsById, new ImageFilter(), this.treeLock);
			}
			return this.images;
		}
	}
	...
	public HTMLCollection getApplets() {
		synchronized(this) {
			if(this.applets == null) {
				...
				this.applets = new FilteredHTMLCollectionImpl(this.elementsById, new AppletFilter(), this.treeLock);
			}
			return this.applets;
		}
	}
	...
	public HTMLCollection getLinks() {
		synchronized(this) {
			if(this.links == null) {
				this.links = new FilteredHTMLCollectionImpl(this.elementsById, new LinkFilter(), this.treeLock);
			}
			return this.links;
		}
	}
	...
	public HTMLCollection getForms() {
		synchronized(this) {
			if(this.forms == null) {
				this.forms = new FilteredHTMLCollectionImpl(this.elementsById, new FormFilter(), this.treeLock);
			}
			return this.forms;
		}
	}
	...
	public HTMLCollection getFrames() {
		synchronized(this) {
			if(this.frames == null) {
				this.frames = new FilteredHTMLCollectionImpl(this.elementsById, new FrameFilter(), this.treeLock);
			}
			return this.frames;
		}
	}
	...
	public HTMLCollection getAnchors() {
		synchronized(this) {
			if(this.anchors == null) {
				this.anchors = new FilteredHTMLCollectionImpl(this.elementsById, new AnchorFilter(), this.treeLock);
			}
			return this.anchors;
		}
	}
	...
	/**
	 * Loads images such that they are shared if from the same URI.
	 * Informs listener immediately if an image is already known.
	 * @param relativeUri
	 * @param imageListener
	 */
	...
	public Object setUserData(String key, Object data, UserDataHandler handler) {
		...
		if(onloadHandler != null) {
			if(org.lobobrowser.html.parser.HtmlParser.MODIFYING_KEY.equals(key) && data == Boolean.FALSE) {
				Executor.executeFunction(this, onloadHandler);
			}
		}
