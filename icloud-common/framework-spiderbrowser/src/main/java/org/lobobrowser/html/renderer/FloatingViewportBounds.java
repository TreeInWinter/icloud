...
public class FloatingViewportBounds {
	private final FloatingViewportBounds prevBounds;
	private final int alignment;
	private final int y;
	private final int width;
	private final int height;
	
	public FloatingViewportBounds(FloatingViewportBounds prevBounds, int alignment, int y, int width, int height) {
	...
	public int getLeft(int y) {
		int left = 0;
		FloatingViewportBounds prev = this.prevBounds;
		if(prev != null) {
			left = prev.getLeft(y);
		}
