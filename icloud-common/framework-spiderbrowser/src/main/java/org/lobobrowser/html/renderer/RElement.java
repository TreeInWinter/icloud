...
public interface RElement extends RCollection, UINode, BoundableRenderable {
	 ...
	 * @param expandWidth Whether width should be expanded to fill availWidth.
	 * @param expandHeight Whether height should be expanded to fill availHeight.
	 */
	public void layout(int availWidth, int availHeight, boolean expandWidth, boolean expandHeight);
