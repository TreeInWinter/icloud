...
public class SimpleHdfsCombiner extends HdfsReducer<Text, BytesWritable, BytesWritable> implements Output<byte[], byte[]> {
	...
	protected void runreduce(byte[] inputkey, Iterator<byte[]> inputvalue) throws IOException {	
		...
		logic.combineLogic(inputkey, inputvalue, this);	
	}
