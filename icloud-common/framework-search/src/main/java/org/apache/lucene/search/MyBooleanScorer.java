...
final class MyBooleanScorer extends Scorer {
      ...
      if (bucket.doc != doc) {                    // invalid bucket
        ...
        table.first = bucket;
    	  ...
    	  //bucket.score += scorer.score(); // increment score
			/** edit by jay */
			if (scorer.score() > bucket.score) {
				bucket.score = scorer.score(); // just the max
			}
  ...
  MyBooleanScorer(Weight weight, boolean disableCoord, Similarity similarity, int minNrShouldMatch,
