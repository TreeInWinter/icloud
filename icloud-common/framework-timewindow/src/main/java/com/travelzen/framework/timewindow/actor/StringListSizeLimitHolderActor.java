 ...
 * 处理如下场景： 
 * 
 *    最近5分钟处理过的url -> （a.com, b.com）, frame中的url按数量过期
 */
public class StringListSizeLimitHolderActor extends String2StringListHolderActor {

	private static Logger logger = LoggerFactory
			.getLogger(StringListSizeLimitHolderActor.class);
...
//		});
	...
	protected void processRequest(String2LongCounterRequest request, RP<?> rp)
			throws Exception {
